	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				// 클라이언트의 접속 요청을 허용
				Socket clientSocket = serverSocket.accept();  //클라이언트는 socket 서버는 serverSocket
															  // 누군가가 접속할때까지 여기에서 기다림
				...
				out.writeUTF("어서오세요 환영합니다!"); //writeUTF 메소드를 이용하면 바이트 스트림으로도 한글 깨짐 없이 데이터를 보낼수 있다.
