...
public class Ex06_LocalDateTime {
	...
	public static void ex01() {
		...
		LocalDate date3 = LocalDate.parse("2023-01-07"); //문자열 기본 형식 : yyyy-MM-dd
	...
	public static void ex03() {
		...
		LocalDateTime dateTime2 = LocalDateTime.of(2023, 1, 17, 15, 4, 30); // 2023-01-17 15시4분30초
		System.out.println(dateTime2);
		LocalDateTime dateTime3 = LocalDateTime.parse("2023-01-17T15:04:30"); //2023-01-17
