...
public class Ex02_Random {
	...
	/*
	  	java.lang.String str = "hello"; //원래 풀네임, 근데 앞에 생략할수있도록 약속해놓음
		java.lang.Math.random(); 
 		...
 		4. import를 생략할 수 있는 경우
 			...
 			2) 동일한 패키지의 클래스
		5. import 방식 : 클래스를 입력할 때 "항상" 자동 완성을 이용한다.(자동완성을 해줘야 임포트를 알아서해준다)
	*/
	...
	public static void ex01() {
		...
		Random random = new Random(); //객체생성 안하고 Math.random 이걸 더 많이 씀
		
		// 실수 난수
		double randNumber1 = random.nextDouble(); // 0.0 <= 난수 < 1.0
		System.out.println(randNumber1);
		
		//정수 난수 그나마 이건 좀 쓴다 위에 실수 난수는 잘 안씀
