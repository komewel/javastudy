...
public class MainClass {
	...
	public static void ex03() {
		...
		//1. 논리 AND의 경우 조건의 결과가 false인 경우가 발생하면 더 이상 동작하지 않는다. 최종 결과가 false로 정해졌기 때문이다.(모든결과가 같아야함)
		//2. 논리 OR의 경우 조건의 결과가 true인 경우가 발생하면 더 이상 동작하지 않는다. 최종 결과가 true로 정해졌기 때문이다.
		int a = 10;
		int b = 10;
		boolean result1 = (a == 20) && (++b == 11);
		System.out.println(b);
		System.out.println(result1);//(a == 20)부터 동작 x
		boolean result2 = (a == 10) || (++b == 11);
		System.out.println(b);
		System.out.println(result2);//(a == 10)부터 동작 x
	}
	...
	public static void main(String[] args) {
		ex07();
		// 연산자는 String 에서는 다른의미를 가짐 ==, != 은 못쓰고 +는 다른의미를 가진다 
	}
